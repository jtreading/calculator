      ...
      <div className={styles.calcCard}>
        ...
        <div className={styles.buttonContainer}>
          <div className={styles.buttonRow}>
            <button type="button" className={styles.secondaryFunctionButton} onClick={() => handleFunction('AC')}>AC</button>
            <button type="button" className={styles.secondaryFunctionButton} onClick={() => handleFunction('+-')}>+/-</button>
            <button type="button" className={styles.secondaryFunctionButton} onClick={() => handleFunction('%')}>%</button>
          ...
          <div className={styles.buttonRow}>
            <button type="button" className={styles.zeroButton} onClick={() => handleNum(0)}>0</button>
